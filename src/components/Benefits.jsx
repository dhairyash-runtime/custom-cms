...
const SMALL_CARDS = [
    ...
    },
    {
        ...
        description:
            'Clean APIs, comprehensive documentation, and developer tools — enabling rapid integration with your existing tech stack and front-end frameworks.',
    ...
    return (
        <section id="benefits" className="relative w-full overflow-hidden font-['Poppins']">
            ...
            <div className="relative z-10 flex flex-col items-center px-4 md:px-10 lg:px-16 pt-14 md:pt-24 pb-0">
                ...
                >
                    Accelerate Growth with<br className="hidden md:block" /> a Custom-Built CMS
                </h2>
                ...
                >
                    A powerful platform with modular architecture for custom CMS,
                    content workflows, and enterprise-grade content management.
                </p>
