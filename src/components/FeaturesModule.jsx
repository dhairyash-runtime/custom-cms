...
const features = [
    {
        ...
        description: 'A fully tailored admin panel designed around your business workflow — with intuitive navigation, analytics widgets, and real-time content overview.',
    ...
    {
        id: 'content-approval',
        title: 'Workflow-Based Content Approval',
        description: 'Define multi-step editorial workflows with draft, review, and publish stages — ensuring content quality and governance across your team.',
        link: 'https://www.runtime-solutions.com/contact/',
        imagePosition: 'left',
        imageBg: 'linear-gradient(135deg, #fcfce3 0%, #e0f2f4 100%)',
        image: 'workflow_content.png',
    },
    {
        id: 'seo-management',
        title: 'SEO Field Management',
        description: 'Built-in SEO fields for meta titles, descriptions, Open Graph tags, canonical URLs, and structured data — manage search visibility directly from the CMS.',
        link: 'https://www.runtime-solutions.com/contact/',
        imagePosition: 'right',
    ...
    },
    {
        id: 'media-library',
        title: 'Media Library',
        description: 'Centralized asset management with drag-and-drop uploads, image optimization, folder organization, and seamless embedding across content types.',
        link: 'https://www.runtime-solutions.com/contact/',
        imagePosition: 'left',
    ...
    },
    {
        ...
        description: 'Granular role-based permissions for admins, editors, contributors, and reviewers — control who can create, edit, publish, or delete content.',
        link: 'https://www.runtime-solutions.com/contact/',
        imagePosition: 'right',
        imageBg: 'linear-gradient(135deg, #e0f2f4 0%, #fcfce3 100%)',
        image: 'multi_role_access.png',
    },
    {
        id: 'api-first',
        title: 'API-First Architecture',
        description: 'Headless CMS design with RESTful and GraphQL APIs — deliver content to websites, mobile apps, IoT devices, and any front-end framework.',
        link: 'https://www.runtime-solutions.com/contact/',
        imagePosition: 'left',
        imageBg: 'linear-gradient(135deg, #fcfce3 0%, #e0f2f4 100%)',
    ...
    },
    {
        ...
        title: 'Government Portal Ready',
        description: 'Enterprise-grade CMS architecture compliant with government standards — built for accessibility, security audits, and high-traffic public portals.',
        link: 'https://www.runtime-solutions.com/contact/',
        imagePosition: 'right',
        imageBg: 'linear-gradient(135deg, #d3ebf0 0%, #faf8c8 100%)',
        image: 'government_portal.png',
    },
];
