    ...
    return (
        <div id="home" className="w-full font-['Poppins'] bg-white flex flex-col items-center justify-center pt-16 pb-12 px-6 md:pt-32 md:pb-24">
            ...
            <p className="text-center text-[#474747] mt-6 md:mt-4 max-w-3xl text-base md:text-[20px] leading-[1.4] px-4 animate-fade-in-up delay-200">
                A modern, React-based content management <br className="md:hidden" />
                system built specifically around <br className="hidden md:inline" />
                your business workflow — fully <br className="md:hidden" />
