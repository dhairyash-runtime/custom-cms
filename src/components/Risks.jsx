...
const cardData = [
    {
        ...
        description: 'Traditional CMS platforms rely heavily on plugins and third-party extensions that introduce security risks, compatibility issues, and maintenance overhead.',
        icon: (
    ...
    },
    {
        ...
        description: 'Generic CMS structures force teams into predefined content workflows that don\'t align with enterprise-specific editorial and approval processes.',
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        description: 'Off-the-shelf CMS platforms offer limited flexibility for custom content types, unique UI layouts, and tailored admin experiences that enterprises require.',
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
        ...
        description: 'As content volume and user traffic grow, traditional CMS platforms struggle with performance, requiring costly infrastructure overhauls and re-architecture.',
        icon: (
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <section className="w-full font-['Poppins'] bg-white flex flex-col items-center pt-20 pb-0 md:pt-28 px-5 md:px-10 lg:px-20">
                ...
                <div className="relative w-full flex flex-col items-center pb-16 md:pb-24 overflow-hidden">
                    ...
                    <h2 className="relative text-center font-medium text-[20px] md:text-[40px] leading-[1.25] tracking-[-0.02em] text-[#2D1206] max-w-[280px] md:max-w-3xl">
                        Challenges of Managing Content without a Custom CMS
                    </h2>

                    {/* Subtitle */}
                    <p className="relative text-center text-[#4C4C4C] mt-4 md:mt-5 text-[20px] md:text-[20px] leading-[1.6] max-w-[300px] md:max-w-lg">
                        Enterprises require tailored workflows
                        <br className="hidden md:block" />
                        that generic CMS platforms simply can\'t deliver.
                    </p>
